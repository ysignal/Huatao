...
struct TapticEngine {
    ...
    public static var impact: Impact = .init()
    public static var selection: Selection = .init()
    public static var notification: Notification = .init()
    ...
    struct Impact {
        ...
        private mutating func updateGeneratorIfNeeded(_ style: ImpactStyle) {
        ...
        public mutating func feedback(_ style: ImpactStyle) {
        ...
        public mutating func prepare(_ style: ImpactStyle) {
            guard #available(iOS 10.0, *) else { return }
